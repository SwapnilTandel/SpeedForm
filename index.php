  ...
  <div class="panel-body">
        <form class="form-inline">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ownAdjustment">
                    <div class="form-group pull-right">
                        <label for="bpsysTextBox">BP Sys:</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ownAdjustment">
                    <div class="form-group pull-right">
                        <label for="diabetesSelect">Diabetes:</label>
                ...
                <div class="col-lg-3 ownAdjustment">
                    <div class="form-group pull-right">
                        <label for="bbdiaTextBox">BB Dia:</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ownAdjustment">
                    <div class="form-group pull-right">
                        <label for="noofyearsTextBox">No Of Years:</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 ownAdjustment">
                    <div class="form-group pull-right">
                        <label for="waistTextBox">Waist:</label>
